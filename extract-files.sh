...
function blob_fixup() {
    case "${1}" in
        vendor/lib64/libsec-ril.so)
            ...
            ;;
        vendor/lib64/hw/gatekeeper.mdfpp.so|vendor/lib64/libskeymaster4device.so|vendor/lib64/libkeymaster_helper.so|vendor/lib/libwvhidl.so|vendor/lib/mediadrm/libwvdrmengine.so)
